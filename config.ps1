...
$AdditionalBackupParameters = @("--exclude-if-present", ".nobackup", "--no-scan","--exclude-cloud-files","--exclude-caches")
...
$MachineConfigPath = "C:\restic\restic-config-$env:COMPUTERNAME.ps1"
